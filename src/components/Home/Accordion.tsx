            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    ...
                    <div className='flex flex-col items-center gap-3'>
                        <h1 className='text-3xl text-base-100 font-inter font-bold'>Buy</h1>
                        <p className='text-base-100 font-inter font-bold'>Explore unique art: Buy captivating illustrations on our creative platform, celebrating individual expression</p>
