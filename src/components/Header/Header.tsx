      ...
      <header className="navbar bg-base-100">
        <div className="navbar-start">
          <nav className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-96 list-none">
              <Link to='/cart'><li><a className="cursor-default font-inter font-light text-4xl mb-3 active:bg-gray-500">Cart</a></li></Link>
              <Link to='/shop'><li><a className="cursor-default font-inter font-light text-4xl mb-3">Shop</a></li></Link>
              <Link to='/aboutus'><li><a className="cursor-default font-inter font-light text-4xl mb-3">About us</a></li></Link>
              <Link to='/contact'><li><a className="cursor-default font-inter font-light text-4xl mb-3">Contact</a></li> </Link>
            </ul>
          </nav>

          <Link to='/'><a className="text-5xl cursor-default font-inter font-bold lg:text-4xl ms-10">Nagai.</a></Link>
        </div>
        ...
        {isAuthenticated ? (
          ...
          <nav className="text-3xl navbar-end space-x-6 me-6 lg:text-xl list-none">
            ...
            <Link to='/cart'><li><a className="hidden cursor-default font-inter font-light lg:block"><img src={cart} alt="cart" width={35} /></a></li></Link>
          </nav>
        )}
      </header>
